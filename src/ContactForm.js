  ...
  return (
    <>
      ...
      <div id="contact" className="contact-area section-padding">
        <div className="container">
          <div className="section-title text-center">
            ...
            <p style={{ fontFamily: 'aveneir next !important' }}>
              I'm always open to hearing about exciting new opportunities in the software
              engineering field. If you're interested in working with a driven and knowledgeable
              developer, don't hesitate to get in touch.
            </p>
          </div>
          <Row>
              ...
              <div className="contact">
                <Form onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <div
                      className="form-group col-md-12 contactmessage"
      ...
      <div
        ...
        style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', fontFamily: 'aveneir next' }}
      >
